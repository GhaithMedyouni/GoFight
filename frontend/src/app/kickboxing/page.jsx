...
export default function KickBoxingPage() {
  ...
  // 🧠 Calculer l'âge d'un athlète
  const calculateAge = (dateNaissance) => {
    if (!dateNaissance) return 0;
    const diff = Date.now() - new Date(dateNaissance).getTime();
    return Math.floor(diff / 31557600000); // nombre d'années
  };
  ...
  // 🔁 Charger les athlètes KickBoxing
  ...
  // 🔍 Filtrer par recherche + catégorie d’âge
    ...
    <div className="p-6 space-y-6 text-white bg-[#0B0B0B] min-h-screen mt-20">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
        ...
        <input
          ...
          placeholder="🔍 Rechercher un athlète KickBoxing..."
